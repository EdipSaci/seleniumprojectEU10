...
public class T1_WebTable_Order_Verify {
    ...
    public void order_name_verify_test(){
        ...
        //Expected: “Bob Martin”
        String exceptedBobName= "Bob Martin";
        String actualBobName = bobMartinCell.getText();

        Assert.assertEquals(actualBobName,exceptedBobName);
        ...
        //Expected: 12/31/2021
        String exceptedBobDate= "12/31/2021";
        String actualBobDate=bobMartinDateCell.getText();
        Assert.assertEquals(actualBobDate,exceptedBobDate);
    }
}
